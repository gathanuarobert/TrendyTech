          ...
          >
            {recoveryScenarios.map((item, idx) => (
              <motion.div 
                key={idx} 
                variants={fadeInUp}
                className="p-8 bg-zinc-900/50 border border-white/5 rounded-2xl hover:border-yellow-400/50 transition-all group"
              >
          ...
          >
            {[
              ...
              <motion.div 
                key={i} 
                variants={fadeInUp}
                className="bg-black p-8 border border-white/5 group hover:bg-yellow-400 transition-all duration-500"
              >
