...
const CCTVKits = () => {
  ...
  const handleWhatsApp = (kitName) => {
    const message = encodeURIComponent(`Hello TrendyTech, I am interested in the ${kitName}. Please let me know the current stock availability.`);
          ...
          <div className="relative bg-[#0d0d0d] border border-white/10 w-full max-w-md md:max-w-4xl max-h-[90vh] overflow-hidden flex flex-col md:flex-row shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <div className="w-full md:w-1/2 p-6 md:p-12 overflow-y-auto">
              <div className="flex flex-col h-full text-left">
                <span className="text-yellow-400 text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] mb-2 block">Premium Kit</span>
