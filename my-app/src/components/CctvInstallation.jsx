    ...
    <div className="min-h-screen bg-black text-white relative font-sans">
      ...
      <section className="py-24 px-6 md:px-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-zinc-900/50 p-1 border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
            <img 
      ...
      <section className="py-20 bg-zinc-950 border-y border-white/5 px-6 md:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, idx) => (
            <div key={idx} className="group relative p-8 bg-black border border-white/5 hover:border-yellow-400/50 transition-all">
